<x-layouts.cashier-sidebar>
  <div class="min-h-screen bg-gray-100 dark:bg-gray-900 p-4 flex flex-col space-y-6">
    ...
    <div class="flex items-center justify-between mb-0">
        ...
        <div class="flex items-center justify-between mb-6">
          <div>
            ...
            <p class="text-xs text-gray-600 dark:text-gray-300 mb-6">Lottery Betting App</p>
          </div>
    ...
    <div class="flex flex-wrap justify-between gap-2 sm:gap-4 mt-4 w-full max-w-md mx-auto">
      ...
      <!-- History -->
      <a href="{{route('cashier.bet.history')}}" class="group flex-1 min-w-[70px] py-3 px-4 text-sm font-semibold bg-white dark:bg-gray-800 rounded-xl 

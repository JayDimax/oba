    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-4 space-y-4">
            ...
            <div class="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-md p-4 shadow">
                <div x-show="tab === 'declare'" x-cloak>
                    <?php echo $__env->make('admin.results.partials.declare-form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
        ...
        <div class="col-span-8">
            ...
            <div class="overflow-x-auto bg-white dark:bg-gray-800 shadow rounded-lg border border-gray-200 dark:border-gray-700 mt-6 p-4">
                <form method="GET" action="<?php echo e(route('admin.results.index')); ?>" class="mb-4 flex items-end gap-4 flex-wrap">
                    <div>
                        ...
                        <select name="game_type" id="filter_game_type" class="mt-1 block w-40 border border-gray-300 dark:border-gray-600 rounded px-3 py-1 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">
                            ...
                            <option value="L2" <?php echo e(request('game_type') == 'L2' ? 'selected' : ''); ?>>L2</option>
                            <option value="S3" <?php echo e(request('game_type') == 'S3' ? 'selected' : ''); ?>>S3</option>
                            <option value="4D" <?php echo e(request('game_type') == '4D' ? 'selected' : ''); ?>>4D</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="game_draw" id="filter_draw" class="mt-1 block w-40 border border-gray-300 dark:border-gray-600 rounded px-3 py-1 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">
                            <option value="">All</option>
                            <option value="14:00" <?php echo e(request('game_draw') == '14:00' ? 'selected' : ''); ?>>2 PM</option>
                            <option value="17:00" <?php echo e(request('game_draw') == '17:00' ? 'selected' : ''); ?>>5 PM</option>
                            <option value="21:00" <?php echo e(request('game_draw') == '21:00' ? 'selected' : ''); ?>>9 PM</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            value="<?php echo e(request('game_date')); ?>"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            value="<?php echo e(request('winning_combination')); ?>"
                        >
                    </div>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
                                <td class="px-4 py-2 text-center text-gray-800 dark:text-gray-300"><?php echo e($loop->iteration); ?></td>
                                <td class="px-4 py-2 font-semibold text-gray-900 dark:text-gray-100"><?php echo e($result->game_type); ?></td>
                                <td class="px-4 py-2 text-gray-800 dark:text-gray-300"><?php echo e($result->game_draw); ?></td>
                                <td class="px-4 py-2 font-mono text-sm text-gray-900 dark:text-gray-100"><?php echo e($result->winning_combination); ?></td>
                                <td class="px-4 py-2 text-gray-800 dark:text-gray-300"><?php echo e(\Carbon\Carbon::parse($result->game_date)->format('M d, Y')); ?></td>
                                ...
                                <td class="px-4 py-2 text-center">
                                    <div class="flex justify-center items-center gap-3">
                                        ...
                                        <!-- Delete Button -->
                                        <form action="<?php echo e(route('admin.results.delete', $result->id)); ?>" method="POST"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u355685815/domains/orcasbettingapp.com/resources/views/admin/results.blade.php ENDPATH**/ ?>
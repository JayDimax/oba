  ...
  <div class="min-h-screen x-cloak dark:bg-gray-900 p-4 flex flex-col space-y-6">
    ...
    <div class="flex items-center justify-between mb-6">
      <div>
        ...
        <span class="text-sm">Agent: <?php echo e(Auth::user()->name); ?></span>
      </div>
        ...
        <div class="flex flex-col justify-center">
          ...
          <div class="flex items-end mt-2 mb-2">
            <span class="font-bold tracking-tight text-gray-900 dark:text-white text-4xl" style="font-size: 3rem;">
              <?php echo e(number_format($todayGross, 2)); ?>
    ...
    <div class="flex flex-wrap justify-between gap-2 sm:gap-4 mt-4 w-full ">
      ...
      <!-- History -->
      <a href="<?php echo e(route('agent.bet.history')); ?>" class="group flex-1 min-w-[70px] py-3 px-4 text-sm font-semibold bg-white bg-gray-800 shadow rounded-lg p-3 dark:bg-gray-800 rounded-xl 
      ...
      <!-- Winnings -->
      <a href="<?php echo e(route('agent.winning')); ?>" class="group flex-1 min-w-[70px] py-3 px-4 text-sm font-semibold bg-white bg-gray-800 shadow rounded-lg p-3 dark:bg-gray-800 rounded-xl 
                    transition duration-150 ease-in-out hover:border-blue-500 active:border-blue-700 focus:outline-none 
                    focus:ring focus:ring-blue-200 flex flex-col items-center justify-center">
        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24" fill="none"
            stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
      ...
      <!-- Results -->
      <a href="<?php echo e(route('agent.results')); ?>" class="group flex-1 min-w-[70px] py-3 px-4 text-sm font-semibold bg-white bg-gray-800 shadow rounded-lg p-3 dark:bg-gray-800 rounded-xl 
                    transition duration-150 ease-in-out hover:border-blue-500 active:border-blue-700 focus:outline-none 
                    focus:ring focus:ring-blue-200 flex flex-col items-center justify-center">
        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24" fill="none"
            stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
      ...
      <!-- Reports -->
      <a href="<?php echo e(route('agent.reports')); ?>" class="group flex-1 min-w-[70px] py-3 px-4 text-sm font-semibold bg-white bg-gray-800 shadow rounded-lg p-3 dark:bg-gray-800 rounded-xl 
                    transition duration-150 ease-in-out hover:border-blue-500 active:border-blue-700 focus:outline-none 
                    focus:ring focus:ring-blue-200 flex flex-col items-center justify-center">
        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24" fill="none"
            stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
    ...
    <div class="mt-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            <?php $__currentLoopData = $topCombinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gameType => $combinations): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white dark:bg-gray-800 shadow rounded-xl p-4">
                    <h3 class="text-lg font-semibold text-gray-700 dark:text-gray-300 capitalize mb-2"><?php echo e($gameType); ?></h3>
                    <ul class="space-y-2">
                        <?php $__empty_1 = true; $__currentLoopData = $combinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $combination): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <li class="flex justify-between items-center bg-gray-100 dark:bg-gray-700 p-2 rounded-md">
                                <span class="text-gray-900 dark:text-white font-medium"><?php echo e($combination->bet_number); ?></span>
                                <span class="text-sm text-gray-600 dark:text-gray-400"><?php echo e($combination->total); ?> bets</span>
                            </li>
...
<?php endif; ?>
<?php /**PATH /home/u355685815/domains/orcasbettingapp.com/resources/views/agent/dashboard.blade.php ENDPATH**/ ?>
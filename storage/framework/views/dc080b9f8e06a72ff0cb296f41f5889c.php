       ...
       <?php
        ...
        ?>
            ...
            <div class="p-2 border rounded bg-gray-50 dark:bg-gray-700 mb-2">
                <div class="font-semibold"><?php echo e($date->format('M d, Y (D)')); ?></div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laragon\www\oba\resources\views/admin/reports/index.blade.php ENDPATH**/ ?>
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/profile', [ProfileController::class, 'adminedit'])->name('profile.admin-edit');
    Route::patch('/profile', [ProfileController::class, 'update'])->name('profile.update');
    Route::patch('/profile', [ProfileController::class, 'adminupdate'])->name('profile.admin-update');
    Route::patch('/profile', [ProfileController::class, 'agentupdate'])->name('profile.agent-update');

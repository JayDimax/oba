...
<div x-data="{ confirm: false, preview: null, loading: false }" class="w-full overflow-auto p-4">
    ...
    >
      ...
      <div class="flex-1">
        ...
        <div class="mt-1 h-full">
          ...
          <template x-if="preview && preview.status === 'ok'">
            <div class="bg-green-50 dark:bg-gray-700 border border-green-300 dark:border-gray-600 rounded-md p-3">
              <ul class="text-sm text-gray-700 dark:text-gray-300 space-y-1">
                ...
                <li class="font-bold text-green-700 dark:text-green-300 mt-1">
          ...
          <template x-if="preview && preview.status === 'remitted'">
            <div class="bg-yellow-100 dark:bg-yellow-800 text-yellow-800 dark:text-yellow-100 rounded-md p-3 text-sm">
              ✅ Remittance already submitted for <span x-text="$refs.date.value"></span>.
            </div>
          </template>

          <template x-if="preview && preview.status === 'empty'">
            <div class="bg-red-100 dark:bg-red-700 text-red-800 dark:text-red-100 rounded-md p-3 text-sm">
              ⚠ No bets or declared winnings for this date.
            </div>
          </template>
        </div>
      </div>

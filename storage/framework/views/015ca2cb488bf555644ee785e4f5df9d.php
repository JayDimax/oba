...
<aside
  ...
  <nav class="flex-1 space-y-1 w-full px-2">
    ...
    <a href="<?php echo e(route('admin.reports.index')); ?>"
      ...
      <span class="truncate" x-show="!$store.layout.sidebarCollapsed" x-transition>Sales Reports</span>
    </a>
...
</aside><?php /**PATH /home/u355685815/domains/orcasbettingapp.com/resources/views/components/admin-sidebar.blade.php ENDPATH**/ ?>
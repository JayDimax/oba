...
<?php $__env->startSection('title', 'Multipliers Settings'); ?>
    ...
    <div class="grid grid-cols-12 gap-6 mb-6">
        ...
        <div class="col-span-12 md:col-span-4">
            <div class="bg-white dark:bg-gray-900 p-6 rounded shadow border dark:border-gray-700">
                <h2 class="text-lg font-bold mb-4 text-gray-800 dark:text-white">Set Multiplier per Game Type</h2>

                <?php if(session('success')): ?>
                    <div class="mb-4 text-green-600 dark:text-green-400 font-semibold"><?php echo e(session('success')); ?></div>
                <?php endif; ?>

                <form action="<?php echo e(route('admin.settings.multipliers.update')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-4">
                        <label for="multiplier" class="block mb-1 font-semibold text-gray-700 dark:text-gray-300">Multiplier Value</label>
                        <input type="number" name="multiplier" id="multiplier" step="0.01" min="1"
        ...
        <div class="col-span-12 md:col-span-8">
            <div class="bg-white dark:bg-gray-900 shadow rounded-lg border border-gray-200 dark:border-gray-700 overflow-x-auto">
                <table class="w-full table-auto text-sm text-left">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $multipliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 border-b dark:border-gray-700 text-gray-700 dark:text-gray-200">
                                ...
                                <td class="px-4 py-2 text-blue-600 dark:text-blue-400"><?php echo e($row->multiplier); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u355685815/domains/orcasbettingapp.com/resources/views/admin/settings/multipliers.blade.php ENDPATH**/ ?>
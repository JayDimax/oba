    ...
    try {
        ...
        foreach ($validated['bets'] as $bet) {
            $savedBets[] = Bet::create([
                ...
                // 'commission_base' => $bet['commission_base'] ?? null,
                // 'commission_bonus' => $bet['commission_bonus'] ?? null,
                'is_winner' => 0,
                'winnings' => 0,
            ]);
        }
...
public function preview(Request $request)
{
    try {
        ...
        $qrCodeImage = QrCode::format('png')->size(120)->generate($qrContent);

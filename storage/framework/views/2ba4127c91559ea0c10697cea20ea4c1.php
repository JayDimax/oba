...
<div class="px-4 sm:px-6 py-6 bg-gray-50 dark:bg-gray-900 min-h-screen">
        ...
        <div class="w-full md:w-1/2 lg:w-1/3 bg-gray-100 dark:bg-gray-700 p-4 rounded shadow">
            <div class="flex justify-between items-center">
                ...
                <p class="text-3xl text-yellow font-semibold text-right">
                    ₱<?php echo e(isset($netSales) ? number_format($netSales, 2) : '0.00'); ?>
    ...
    <div class="w-full mb-6">
        <div class="bg-gray-100 dark:bg-gray-700 p-4 rounded shadow">
            <div class="text-center text-gray-800 dark:text-yellow-400 text-2xl">
                L2 Gross: ₱<?php echo e(number_format($l2Gross ?? 0, 2)); ?> &nbsp;|&nbsp; 
                S3 Gross: ₱<?php echo e(number_format($s3Gross ?? 0, 2)); ?> &nbsp;|&nbsp; 
                4D Gross: ₱<?php echo e(number_format($d4Gross ?? 0, 2)); ?>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-10">
        ...
        <section class="w-full bg-white dark:bg-gray-800 p-4 rounded shadow">
            ...
            <div class="flex justify-between text-red-600 dark:text-yellow-400"><span>Agents With Balance:</span><span><?php echo e(isset($agentsWithBalance) ? $agentsWithBalance : 'N/A'); ?></span></div>
        </section>
    ...
    <form method="GET" action="<?php echo e(route('admin.admindashboard')); ?>" class="mb-6 grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">
        ...
        <div>
            ...
            <input type="date" name="to_date" value="<?php echo e(request('to_date', $to ?? \Carbon\Carbon::today()->toDateString())); ?>"
                class="w-full mt-1 p-2 border rounded dark:bg-gray-800 dark:text-white dark:border-gray-600">
        </div>
    ...
    <div class="mt-4"> 
        <?php if(isset($bets) && $bets instanceof \Illuminate\Pagination\LengthAwarePaginator): ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laragon\www\oba\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>
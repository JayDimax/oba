...
<head>
    ...
    <meta charset="UTF-8" />
    <title>Cashier Panel - @yield('title')</title>
...
>
            ...
            <div x-show="!sidebarCollapsed" x-transition class="p-4 border-b dark:border-gray-700 text-center">
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400 truncate">{{ Auth::user()->agent_code ?? 'No Code' }}</p>
            ...
            <nav class="flex-1 mt-2 space-y-1">
                ...
                <a href="{{ route('cashier.dashboard') }}"
                    :class="{
                        'bg-blue-100 dark:bg-gray-700 text-blue-700 dark:text-blue-300 font-semibold':
                            $store.layout.sidebarCollapsed ? false : {{ request()->routeIs('cashier.dashboard') ? 'true' : 'false' }},
                ...
                <a href="{{ route('cashier.remittance') }}"
                    :class="{
                        'bg-blue-100 dark:bg-gray-700 text-blue-700 dark:text-blue-300 font-semibold':
                            {{ request()->routeIs('cashier.remittance') ? 'true' : 'false' }},
                        'hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200': true
                    }"
                    class="flex items-center px-4 py-2 transition">
                ...
                <a href="{{ route('cashier.pending') }}"
                    :class="{
                        'bg-blue-100 dark:bg-gray-700 text-blue-700 dark:text-blue-300 font-semibold':
                            {{ request()->routeIs('cashier.pending') ? 'true' : 'false' }},
                        'hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200': true
                    }"
                    class="flex items-center px-4 py-2 transition">
                ...
                <a href="{{ route('cashier.receipts.index') }}"
                    :class="{
                        'bg-blue-100 dark:bg-gray-700 text-blue-700 dark:text-blue-300 font-semibold':
                            {{ request()->routeIs('cashier.receipts.index') ? 'true' : 'false' }},
                        'hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200': true
                    }"
                    class="flex items-center px-4 py-2 transition">
                ...
                <a href="{{ route('cashier.reports') }}"
                    :class="{
                        'bg-blue-100 dark:bg-gray-700 text-blue-700 dark:text-blue-300 font-semibold':
                            {{ request()->routeIs('cashier.reports') ? 'true' : 'false' }},
                        'hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200': true
                    }"
                    class="flex items-center px-4 py-2 transition">
            ...
            <div class="mt-auto p-4 border-t dark:border-gray-700">
                ...
                {{-- <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit"
                        class="flex items-center w-full text-left text-sm text-red-600 dark:text-red-400 hover:underline">
